...
ALTER SEQUENCE public.command_id_seq OWNER TO davide;
...
ALTER SEQUENCE public.profile_id_seq OWNER TO davide;
...
ALTER SEQUENCE public.rating_id_seq OWNER TO davide;
...
ALTER TABLE ONLY public.news
    ADD CONSTRAINT news_pkey PRIMARY KEY (latest_id);
...
GRANT ALL ON SCHEMA public TO davide;
